...
INSERT INTO ST_USER (ID, NAME, LOGIN, PASS, EMAIL, ROLE, ACCOUNTING) VALUES (-1, 'admin1', 'admin1', 'admin1', 'admin@devtty.de', 'Admin', 1);
INSERT INTO ST_USER (ID, NAME, LOGIN, PASS, EMAIL, ROLE, ACCOUNTING) VALUES (-2, 'user11', 'user11', 'user11', 'user@devtty.de', 'User', 1);
...
INSERT INTO ST_USER (ID, NAME, LOGIN, PASS, EMAIL, ROLE, ACCOUNTING, STORE_ID) VALUES (-4, 'store1', 'store1', 'store1', 'store@devtty.de', 'Store', 0, -1);